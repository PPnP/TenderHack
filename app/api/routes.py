...
from app.api.controllers.default_index import DefaultIndexController
api.add_url_rule('/', view_func=DefaultIndexController.as_view('DefaultIndex'))
...
from app.api.controllers.supplier import SupplierController
api.add_url_rule('/supplier', view_func=SupplierController.as_view('Supplier'))
